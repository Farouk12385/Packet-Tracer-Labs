...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/Farouk12385/Packet-Tracer-Labs.git
   ```

2. Open any lab folder
...
Feel free to fork the repo, improve labs, or add new ones!
